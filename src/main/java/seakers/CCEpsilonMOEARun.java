...
import seakers.search.ClimateCentricProblemSearch;
import seakers.search.problems.Assigning.AssigningArchitecture;
import seakers.search.problems.Assigning.AssigningProblem;
...
public class CCEpsilonMOEARun {
    ...
    public static void main(String[] args){
        ...
        RunMode mode = RunMode.RandomPopulation;
